...
```text
input:รับข้อความ
output:สระที่นับได้ในข้อความที่ให้ไป
constraints:ตัวอักษรเล็กใหญ่นับเป็นตัวเดียวกัน
...
```text
step1:สร้างลิสต์สระกับลิสสำหรับนับ
step2:เมื่อให้อินพุตเข้าไป นำอินพุตไปเช็คว่ามีตัวอักษรตรงกับลิสของสระไหม
step3:ให้ตัวแปรนับ นับตามจำนวนลูปที่เกิดขึ้น
```
...
```text
วิธีสุดท้ายหมือนกับแผนแรก outputให้นัลสระแต่ละตัว ตัวที่เป็น0ไม่ต้องแสดง
