...
```text
input:รับข้อมูล4อย่าง
output:นำข้อมูลที่ได้มาเข้าลูปเพื่อหาว่ามีตัวที่หารลงตัวทั้งหมดกี่ตัว
constraints:bต้องมากกว่าaและdต้องมากกว่าr
```
...
```text
step1:รับค่าทั้งสี่
step2:ตั้งตัวแปรไว้สำหรับนับจำนวนลูปที่ตรงเงื่อนไข
step3:ในลูปต้องหยุดที่b+1เพื่อให้นำค่าbไปคิดด้วย
step4:นำค่าที่อยู่ในช่วงทั้งหมดไปหารกับdเพื่อให้ได้เศษเป็นrแล้วนับว่ามีทั้งหมดกี่ครั้ง
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก outputที่ได้มากจากการนำตัวแปรที่ใช้นับบวกไปตามลูปที่เกิดขึ้น
```
