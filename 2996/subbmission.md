...
```text
รับinputเป็นสตริง
outputนำมากลับหลังด้วยการsliceพร้อมกับทำให้เป็นตัวอักษรเล็กด้วย lower
```
...
```text
Step 1:นำสตริงเข้าinput
Step 2:ทำให้ข้อความที่มามีoutputแบบกลับหลัง
Step 3:นำข้อความที่กลับหลังแล้วมาทำเป็นตัวอักษรเล็ก
```
...
```text
ใช้วิธีเดียวกับแผนแรกเนื่องจากลองเทสแล้วไม่พบปัญหา
```
...
```text
เพราะมีตัวอักษรเล็กใหญ่สลับกัน
```
...
```text
ทำความเข้าใจโจทย์เอง หาคำสั่งที่ต้องใช้เอง เขียนโค้ดเอง
```
