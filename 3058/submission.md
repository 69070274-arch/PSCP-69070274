...
```text
input:รับจำนวนอิฐที่ต้องการจะใช้และเป้าหมาย
output:จำนวนอิฐก้อนเล็กที่ต้องใช้โดยต้องใช้อิฐก้อนใหญ่ให้ได้มากี่สุด
```
...
```text
step1:รับค่าก้อนอิฐที่ต้องใช้และเป้าหมาย
step2:หาว่าใช้อิฐก้อนใหญ่ได้มากสุดกี่ก้อนโดยการนำเป้าหมายหารไม่เอาเศษกับอิฐใหญ่ที่คูณ5มาแล้ว
step3:ที่เหลือให้ใช้อิฐก้อนเล็ก
```
...
```text
ใช้เหมือนกับแผนแรก ก่อนได้ผลลัพธ์ต้องอิฐก้อนเลขมีพอสำหรับที่ต้องการหรือไม่
```
...
```text
ลองกรณีที่อิฐใหญ่เกินแต่อิฐเล็กไม่พอ
```
