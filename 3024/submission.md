...
```text
input  รับคะแนนรวม และคะแนนสูงสุด
output เช็คคะแแนนแล้วดุว่าผลออกมาเป็น"Surprising" หรือ "Not surprising"
```
...
```text
หาคะแนนที่ต่ำที่สุดเท่าที่เป็นไปได้จากการนำคะแนนสูงสุดทั้งสองคะแนนคูณกันแล้วนำไปลบกับคะแนนรวม แล้วดูว่าคะแนนต่ำสุดกับสูงสุดห่างกันเกินสองคะแนนหรือไม่
```
...
```text
ใช้วิธีเดียวกับวิธีแรก โดยคะแนนต่ำที่สุดไม่สามารน้อยกว่า0ได้จึงต้องทำให้คะแนนต่ำสุดที่ออกมาไม่เป็นลบก่อน จากนั้นจึงนำไปคิดต่อ
```
