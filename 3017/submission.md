...
```text
โจทย์ให้หาราคาทั้งหมดที่ต้องจ่ายโดยเป็นราคาอาหารบวกด้วยค่าบริการ
input:ราคาอาหารก่อนรวมค่าบริการ
output:ราคาอาหารหลังรวมค่าบริการ
constraints:ในกรณีที่ค่าบริการน้อยไปให้คิดเป็น50 และค่าบริการต้องไม่เกิน1000
...
```text
Step 1:รับค่าอาหารตั้งต้น
Step 2:สร้างกรณีที่ค่าบริการเป็น50
Step 3: สร้างกรณีที่ค่าบริหารเป็น1000
Step 4: ค่าบริการในกรณีนอกเหนือจากนั้นจะะเป็นการคิดปกติโดยคืดเป็น10%ของค่าอาหาร
Step5:นำค่าอาหารกับบริการที่ได้มาคูณ1.07ที่หมายถึงvatเพื่อให้ได้ค่าใช้จ่ายทั้งหมด
```
...
```text
ใช้เหมือนกับแผนแรก โดยค่าใช้จ่ายทั้งหมดจะต้องออกมาเป็นทศนิยม2ตำแหน่ง
```
