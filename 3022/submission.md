...
```text
input:อุณหภูมิในหน่วยหนึ่งที่ต้องการเปลี่ยนเป็นอีกหน่วยหนึ่ง
output:อุณหภูมิในหน่วยที่ต้องการ
constraints:หน่วยที่ให้ และต้องการแต่ละหน่วยมีสูตรคิดที่แตกต่างกันไป
```
...
```text
Step 1:นำค่าที่รับไม่ว่าจะหน่วยไหน แปลงเป็นหน่วยเหมือนกันให้หมดเพื่อให้ง่ายต่อการคิด
Step 2:หลังจากเปลี่ยนเป็นหน่วยที่เลือกแล้ว นำเข้าเงื่อนไขถัดไปเพื่อให้ได้หน่วยที่ต้องการ
Step 3:หลังจากได้ตัวเลขที่ต้องการแล้วให้ทำเป็นทศนิยมสองตำแหน่ง
```
...
```text
ใช้วิธีเดียวกัลแผนแรก โดยการนำอินพุตมาแปลงเป็นcก่อน แล้วนำอุณหภูมิที่เปลี่ยนแล้วไปคิดหาหน่วยที่ต้องการต่อ
```
