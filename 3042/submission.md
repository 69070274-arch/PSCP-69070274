...
```text
input:รับตัวเลข
output:ดูว่าภายในช่วงตัวเลขที่รับมานั้น มีตัไหนบ้างที่หาร10ลงตัว
```
...
```text
step1:รับตัวเลข
step2:นำตัวเลขที่รับมาหารว่าตัวเลขในช่วงนั้นมีตัวไหน้บางที่หารสิบลงตัวโดยการใช้loop
...
```text
ใช้เหมือนกับแผนแรก และมีการทำให้outputนั้นอยู่ในบรรทัดเดียวกัน
```
