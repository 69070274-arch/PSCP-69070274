...
```text
ตรวจว่าinputเป็นข้อความที่ตรงกับที่โจทย์ต้องการหรือไม่ แล้วoutputต้องมาจากการตรวจสอบinputที่ตรงกับเงื่อนไขที่ใส่ไป
```
...
```text
Step 1:รับinputเป็นสตริงแล้วนำมาตรวจสอบว่าทั้งสองนั้นตรงกับคำที่ต้องหารหรือไม่
Step 2:หากตรงกับคำที่ต้องการแล้ว ให้นำทั้ง2คำที่ได้มาเช็คว่าเข้ากับเงื่อนไขไหน
Step 3:ตั้งเป็นสามเงื่อนไขตามโจทย์ หากไม่ตรงให้print error
```
...
```text
มีเงื่อนไขอีกเงื่อนไขหนึ่งที่ไม่ได้ให้มาในโจทย์ ต้องเพิ่มเงื่อนไขนี้เข้าไป 
```
