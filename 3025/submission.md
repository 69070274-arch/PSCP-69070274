...
```text
input:วันและเดือน
output:ฤดูที่สอดคล้องกับเดือนและวัน
constrains:หากเป็นเดือนที่หารด้วย3ลงตัวแล้วเป็นวันที่21ขึ้นไป จะเป็นฤดูใหม่
```
...
step2:หากเดือนที่ใส่ไปเป็นเดือนที่3หารลงตัวและเป็นวันที่21ขึ้นไป จะเป็นการขึ้นฤดูใหม่
step3:ตรวจสอบด้วยเทสเคสแล้วดูว่าผิดตรงไหน
...
```text
รับค่าวันและเดือน กำหนดว่าช่วงเดือนแต่ละช่วงควรเป็นฤดูอะไร หากเดือนที่ใส่ไปเป็นเดือนที่3หารลงตัวและเป็นวันที่21ขึ้นไป จะเป็นการขึ้นฤดูใหม่ 
```
