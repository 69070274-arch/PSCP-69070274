...
```text
input:พื้นที่มึงที่ขยายต่อวินาทีและจพนวนคนในบรรทัดเดียวกัน
output:บ้านจะถูกน้ำท่วมในวินาทีที่เท่าไร
```
...
```text
step1:รับข้อมูลพื้นที่และจำนวนคน
step2:รับพิกัดตามจำนวนคน
step3:นำพิดกัดแต่ละคนมาคิดหาพื้นที่
step4:นำพื้นที่ที่ได้มาหารกับพื้นที่ที่ใส่ไปตอนแรก
```
...
```text
ใช้แผนเดียวกับแผนแรก โดยเวลาที่ได้ ให้นำมันปัดขึ้น
```
